...
async function getCoordinates(city) {
    ...
    const url = `https://api.opencagedata.com/geocode/v1/json?q=${!!city === true ? city : `${coord.lat}+${coord.lng}`}&language=en&key=fea627d3cffd4ef29a04ebe0aca34cc4&pretty=1&no_annotations=1`;
